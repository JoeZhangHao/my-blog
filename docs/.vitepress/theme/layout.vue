...
import SlugList from './components/SlugList.vue';
import { isSideBarEmpty, getSideBarConfig } from './support/side-bar';
...
<template>
  <div class="theme" :class="pageClasses">
    ...
    <ClientOnly v-if="isCustomLayout">
      <Content />
    </ClientOnly>
    ...
    <Page v-else>
      <template #top>
        <slot name="page-top-ads">
          <div v-if="theme.carbonAds && theme.carbonAds.carbon" id="ads-container">
            <CarbonAds
